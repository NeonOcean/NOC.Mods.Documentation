...
StructurePath = os.path.join(RootPath, "Structure")  # type: str
StructureBuildPath = os.path.join(StructurePath, "Build")  # type: str
StructureSourcePath = os.path.join(StructurePath, "Structure")  # type: str
